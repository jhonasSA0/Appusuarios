        ...
        <View style={styles.container}>
            ...
            <View style={styles.conttext}>
                ...
                <View style={styles.Btn}>
                    <ReusableButton onPress={() => navigation.navigate("Login")} title={"Guardar"} buttonStyle={{ backgroundColor: "#C35120", borderRadius: 20, height: 50, justifyContent: "center" }} textStyle={{ fontSize: 25, fontWeight: "bold" }} />
                </View>
