...
export default function DirectListTemplate() {
    ...
    return (
        <View style={styles.container}>
            ...
            <View style={styles.contlist}>
                <ReusableText children={"Directores"} color='#7E8084' fontSize={15} />
            ...
            <View style={styles.btn}>
                <ReusableButton onPress={() => navigation.navigate("DirectRegister")} title={"+ Nuevo"} buttonStyle={{width: "100%", backgroundColor:"#C35120", borderRadius:50, height:40, justifyContent:"center"}} textStyle={{fontSize:18,fontWeight:"bold"}}/>
            </View>
